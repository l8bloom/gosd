// example on how to use gosd to generate an image with applied high-res upscaler
...
func main() {
	...
	// prompts
	imgParams.Prompt = "A lone cyberpunk ronin walking through a rain-soaked neon alley at night, reflective wet pavement, glowing holographic signs, intricate futuristic armor with fine mechanical details, cinematic atmosphere, volumetric fog, dramatic rim lighting, ultra detailed textures, sharp focus, dynamic composition, realistic rain particles, masterpiece quality digital art."

	imgParams.NegativePrompt = "low quality, blurry, distorted anatomy, extra limbs, poorly drawn hands, flat lighting, oversaturated colors, watermark, text, logo, cropped, out of frame"
	...
	imgParams.HiresParams.Steps = 20
	// lower keeps it similar to 1st pass image, higher brings more variance
	imgParams.HiresParams.DenoisingStrength = 0.5
