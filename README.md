...
After that, the only thing left is to get the stable-diffusion shared libraries. Currently, [master-580-7d33d4b](https://github.com/leejet/stable-diffusion.cpp/releases/tag/master-580-7d33d4b) is supported.  
